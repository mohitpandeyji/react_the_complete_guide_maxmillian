...
class Persons extends Component{
    ...
    shouldComponentUpdate(nextProps, nextState){
        console.log("[Persons.js] shouldComponentUpdate lifecycle hook", nextProps, nextState);
        return true;

    }

    getSnapshotBeforeUpdate(preProps,prevState){
        console.log("[Persons.js] getSnapshotBeforeUpdate lifecycle hook", preProps, prevState);
        // return null
